...
async function setPage(name) {
  ...
  if (wireframes[name] == null) {
    ...
    await loadScript("https://app.photop.live/pages/" + name + ".js");
...
async function refreshPage() {
  ...
  if (wireframes[currentPage] == null) {
    ...
    await loadScript("https://app.photop.live/pages/" + currentPage + ".js");
...
async function getModule(name) {
  if (modules[name] == null) {
    ...
    await loadScript("https://app.photop.live/modules/" + name + ".js");
...
async function loadScript(url) {
  return new Promise(function(resolve) {
    ...
    newScript.src = url.replace('./', 'https://app.photop.live/');
